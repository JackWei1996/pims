...
public class CodeGenerator {
    private static final String AUTHOR = "园区招商管理系统";
    private static final String PARENT = "com.pims";
    private static final String[] TABLES = {"attract","comment","company","complaint","contract","page",
            "project","role","role_page","user","user_role","word"};
